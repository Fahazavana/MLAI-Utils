...
train_data = datasets.CIFAR10(root=cifar_train_path, download=False, transform=transforms.ToTensor())
...
print("Test data")
test_data = datasets.CIFAR10(root=cifar_test_path, download=False, transform=transforms.ToTensor())
...
train_data = datasets.MNIST(root=MNIST_train_path, download=False, transform=transforms.ToTensor())
trainloader = DataLoader(train_data, batch_size=256)
print("Train data")
mean, std = get_mean_std(trainloader)
...
print("Test data")
test_data = datasets.MNIST(root=MNIST_test_path, download=False, transform=transforms.ToTensor())
testloader = DataLoader(test_data, batch_size=256)
mean, std = get_mean_std(testloader)
print(mean) # tensor([0.1307])
print(std)  # tensor([0.3081])
...
train_data = datasets.FashionMNIST(root=FashionMNIST_train_path, download=False, transform=transforms.ToTensor())
trainloader = DataLoader(train_data, batch_size=256)
print("Train data")
mean, std = get_mean_std(trainloader)
...
print("Test data")
test_data = datasets.FashionMNIST(root=FashionMNIST_test_path, download=False, transform=transforms.ToTensor())
testloader = DataLoader(test_data, batch_size=256)
mean, std = get_mean_std(testloader)
print(mean) # tensor([0.2860])
print(std)  #tensor([0.3530])
